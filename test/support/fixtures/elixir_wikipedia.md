...
[![](/static/images/icons/wikipedia.png)![Wikipedia](/static/images/mobile/copyright/wikipedia-wordmark-en.svg)![The Free Encyclopedia](/static/images/mobile/copyright/wikipedia-tagline-en.svg)](/wiki/Main_Page) [Search](/wiki/Special:Search)

# Elixir (programming language) 28 languages From Wikipedia, the free encyclopedia

Programming language running on the Erlang virtual machine


| [![](//upload.wikimedia.org/wikipedia/en/thumb/9/99/Question_book-new.svg/60px-Question_book-new.svg.png)](/wiki/File:Question_book-new.svg) | This article

**relies excessively on [references](/wiki/Wikipedia:Verifiability) to [primary sources](/wiki/Wikipedia:No_original_research#Primary,_secondary_and_tertiary_sources)**

.

Please improve this article by adding [secondary or tertiary sources](/wiki/Wikipedia:No_original_research#Primary,_secondary_and_tertiary_sources).  
...
*( [Learn how and when to remove this message](/wiki/Help:Maintenance_template_removal))* |



| Elixir | Elixir |
| --- | --- |
| [![elixir programming language](//upload.wikimedia.org/wikipedia/en/thumb/b/b9/Elixir_programming_language_logo.svg/250px-Elixir_programming_language_logo.svg.png)](/wiki/File:Elixir_programming_language_logo.svg) Elixir | [![elixir programming language](//upload.wikimedia.org/wikipedia/en/thumb/b/b9/Elixir_programming_language_logo.svg/250px-Elixir_programming_language_logo.svg.png)](/wiki/File:Elixir_programming_language_logo.svg) Elixir |
...
|  |  |
| [Stable release](/wiki/Software_release_life_cycle) | 1.18.4

<sup>[[ 1 ]](#cite_note-wikidata-38d73dbc67fe379aec44b4c951a0b1d72113a0cd-v18-1)</sup>

[![Edit this on Wikidata](//upload.wikimedia.org/wikipedia/en/thumb/8/8a/OOjs_UI_icon_edit-ltr-progressive.svg/20px-OOjs_UI_icon_edit-ltr-progressive.svg.png)](https://www.wikidata.org/wiki/Q5362035?uselang=en#P348)
...
| [Clojure](/wiki/Clojure), [Erlang](/wiki/Erlang_(programming_language)), [Ruby](/wiki/Ruby_(programming_language)) | [Clojure](/wiki/Clojure), [Erlang](/wiki/Erlang_(programming_language)), [Ruby](/wiki/Ruby_(programming_language)) |
| Influenced | Influenced |
| [Gleam](/wiki/Gleam_(programming_language)), [LFE](/wiki/LFE_(programming_language)) | [Gleam](/wiki/Gleam_(programming_language)), [LFE](/wiki/LFE_(programming_language)) |
...
[ [edit](/w/index.php?title=Elixir_(programming_language)&action=edit&section=1) ]
...
[ [edit](/w/index.php?title=Elixir_(programming_language)&action=edit&section=2) ]

Each of the minor versions supports a specific range of Erlang/ [OTP](/wiki/Open_Telecom_Platform) versions. <sup>[[ 14 ]](#cite_note-14)</sup> The current stable release version is 1.18.4 <sup>[[ 1 ]](#cite_note-wikidata-38d73dbc67fe379aec44b4c951a0b1d72113a0cd-v18-1)</sup> [![Edit this on Wikidata](//upload.wikimedia.org/wikipedia/en/thumb/8/8a/OOjs_UI_icon_edit-ltr-progressive.svg/20px-OOjs_UI_icon_edit-ltr-progressive.svg.png)](https://www.wikidata.org/wiki/Q5362035?uselang=en#P348).

## Features

[ [edit](/w/index.php?title=Elixir_(programming_language)&action=edit&section=3) ]
...
[ [edit](/w/index.php?title=Elixir_(programming_language)&action=edit&section=4) ]
...
```
def fib(n) when n in [0, 1], do: ndef fib(n), do: fib(n-2) + fib(n-1)
```

Relational databases with the Ecto library:

```
schema "weather" do  field :city     # Defaults to type :string  field :temp_lo, :integer  field :temp_hi, :integer  field :prcp,    :float, default: 0.0endWeather |> where(city: "Kraków") |> order_by(:temp_lo) |> limit(10) |> Repo.all
```
...
[ [edit](/w/index.php?title=Elixir_(programming_language)&action=edit&section=5) ]

- ![](//upload.wikimedia.org/wikipedia/commons/thumb/3/31/Free_and_open-source_software_logo_%282009%29.svg/40px-Free_and_open-source_software_logo_%282009%29.svg.png) [Free and open-source software portal](/wiki/Portal:Free_and_open-source_software)
...
[ [edit](/w/index.php?title=Elixir_(programming_language)&action=edit&section=6) ]

1. ^ [<sup>***a***</sup>](#cite_ref-wikidata-38d73dbc67fe379aec44b4c951a0b1d72113a0cd-v18_1-0) [<sup>***b***</sup>](#cite_ref-wikidata-38d73dbc67fe379aec44b4c951a0b1d72113a0cd-v18_1-1) *["Release 1.18.4"](https://github.com/elixir-lang/elixir/releases/tag/v1.18.4). 21 May 2025. Retrieved 25 May 2025.*
...
13. **[^](#cite_ref-13)** *["Numerical Elixir (Nx)"](https://github.com/elixir-nx). *[GitHub](/wiki/GitHub)*. Retrieved 2024-05-06.*
...
[ [edit](/w/index.php?title=Elixir_(programming_language)&action=edit&section=7) ]

- *Simon St. Laurent; J. Eisenberg (December 22, 2016). *Introducing Elixir: Getting Started in Functional Programming 2nd Edition*. [O'Reilly Media](/wiki/O%27Reilly_Media). [ISBN](/wiki/ISBN_(identifier)) [978-1491956779](/wiki/Special:BookSources/978-1491956779).*
- *Sasa Juric (January 12, 2019). *Elixir in Action 2nd Edition*. [Manning Publications](/wiki/Manning_Publications). [ISBN](/wiki/ISBN_(identifier)) [978-1617295027](/wiki/Special:BookSources/978-1617295027).*
